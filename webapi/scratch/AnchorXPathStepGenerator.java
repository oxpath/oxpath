...
/**
 * 
 * TODO this is not used right now. We should factor this into the XPathStepGenerator interface; actually, we should
 * rewrite this, such that each local step uses the XPathStepGenerator.
 * 
 * @author Jochen K
 * @author Christian Schallhart <christian@schallhart.net>
 * 
 */
public class AnchorXPathStepGenerator implements XPathLocator {

  @Override
  public XPathNodePointerRanking getAllXPathPointers(final DOMNode node) throws WebAPIException {
    // TODO Auto-generated method stub
    return null;
  }

  @Override
  public XPathNodePointerRanking getAllXPathPointers(final DOMNode node, final Score threshold) throws WebAPIException {
    return null;
  }
  ...
  public static XPathNodePointerRanking getAllXPathPointers(final DOMNode node, final DOMNode rootNode,
      final String rootPath, final int maxAxisSteps, final Score threshold) {
    ...
    if (targetElement != null) {
      ...
      if (FinderUtils.checkThreshold(targetCandidateList, threshold.getThresold()))
  ...
  private static XPathNodePointerRanking findOXPathOnParentAxisWithPositionWeight(final DOMNode rootNode,
      final String rootPath, final DOMElement targetElement, final int maxAxisSteps, final Score threshold) {
  ...
  private static XPathNodePointerRanking findOXPathWithAnchor(final DOMNode rootNode, final String rootPath,
      ...
      final float absolutePathWeight, final int maxAxisSteps, final Score threshold) {
    final XPathNodePointerRanking targetCandidateList = XPathNodePointerRankingOnSet.newRank();
