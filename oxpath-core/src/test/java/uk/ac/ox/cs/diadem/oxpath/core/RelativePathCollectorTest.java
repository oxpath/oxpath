...
public class RelativePathCollectorTest extends AbstractOXPathTestCase {

  private final String expression;

  public RelativePathCollectorTest(final String expression) {
  ...
  public static Collection<Object[]> data() throws IOException, ParseException {
    final List<String> readLines = Resources.readLines(
        RelativePathCollectorTest.class.getResource("attr-collection.txt"), Charsets.UTF_8);
  ...
  public void testAttributeCollection() throws IOException, OXPathException {
    ...
    final RelativePathCollector collector = new RelativePathCollector();
    collector.accept(root, null);
