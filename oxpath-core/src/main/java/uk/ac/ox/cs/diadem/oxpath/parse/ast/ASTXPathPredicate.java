...
public class ASTXPathPredicate extends uk.ac.ox.cs.diadem.oxpath.parse.ast.custom.ASTXPathPredicateCustom {
  public ASTXPathPredicate(final int id) {
    super(id);
  }

  public ASTXPathPredicate(final OXPathParser p, final int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=94cfe65913d850c016675f5d14bc8a8d (do not edit this line) */
